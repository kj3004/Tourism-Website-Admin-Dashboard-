...
<html>
    <head>
        <title>Guide_Me | Admin Package Creation</title>
                            ...
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="destination_category" value="<?php echo htmlentities($destinationDetails->category);?>" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <img src="pacakgeimages/<?php echo htmlentities($destinationDetails->image); ?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($destinationDetails->destination_id); ?>">Change Image</a>
                                        </div>
                                    </div>
